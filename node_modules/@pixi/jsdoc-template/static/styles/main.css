...
.navigation .item,
.navigation .itemMembers,
.navigation .itemMembers li {
  display: none;
}
.navigation.not-searching .item {
  display: block;
}
.navigation.not-searching .item.current .itemMembers,
.navigation.not-searching .item.current .itemMembers li {
  display: block;
}
.navigation.searching .item.match {
  display: block;
}
.navigation.searching .item.match .itemMembers li.match,
.navigation.searching .item.match .itemMembers.match {
  display: block;
}
.content-size {
  max-width: 1000px;
