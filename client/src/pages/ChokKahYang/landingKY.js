        ...
        <div className="flex">
          <div className={"base-page-header"}>
            ...
            <div className="h5 text-white-50">
              <p>
                Hi, KY here, Trainee Backend Developer <br />
                in <strong className="h3 text-white">
                  SNSoft Sdn Bhd
                </strong>. <br />
              </p>
            </div>
        ...
        <div className="glass">
          <div className="h5 p-4">
            ...
            <p>
              LinkedIn:{" "}
              <a
                className="text-decoration-none text-white btn btn-outline-dark p-1.5"
                href="https://www.linkedin.com/in/kah-yang-chok-3bb526190/"
              >
                KY Chok
              </a>{" "}
            </p>
